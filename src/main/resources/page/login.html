...
function changeCode(){
    $("#captcha_img").attr("src", "/captcha.jpg?t="+ (new Date().getTime()));
}
function choose_bg() {
        ...
        <form action="/admin/login" id="login_form" method="post">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="j_username" name="uname" value="" placeholder="登录账号" aria-describedby="sizing-addon-user">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
